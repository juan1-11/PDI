...
advancement revoke @s only pdi:cegador_kill2

#2.Se utiliza el numero aleatorio para determinar si se da o no
execute if score #game random matches 100..160 run give @s iron_nugget{display:{Name:'{"text": "Parte de cuerpo", "color": "light_purple"}'}, Enchantments:[{id:protection,lvl:1s}], HideFlags:1, corp_part: 1b} 1 
