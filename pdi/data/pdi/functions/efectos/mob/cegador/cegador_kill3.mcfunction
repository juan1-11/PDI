...
advancement revoke @s only pdi:cegador_kill3 cegador_parca

#2.Se utiliza el numero aleatorio para determinar si se da o no
execute if score #game random matches 100..160 run give @s diamond{display:{Name:'{"text": "Parte de mente", "color": "light_purple"}'}, Enchantments:[{id:protection,lvl:1s}], HideFlags:1, mind_part: 1b} 1 
