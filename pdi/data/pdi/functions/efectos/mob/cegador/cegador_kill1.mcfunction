...
advancement revoke @s only pdi:mobs/cegador/cegador_kill1

#2.Se utiliza el numero aleatorio para determinar si se da o no
execute if score #game random matches 100..140 run give @s gold_nugget{display:{Name:'{"text": "Parte de Alma", "color": "light_purple"}'}, Enchantments:[{id:protection,lvl:1s}], HideFlags:1, soul_part: 1b} 1 
