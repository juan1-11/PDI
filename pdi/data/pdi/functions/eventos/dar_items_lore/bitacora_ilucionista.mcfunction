...
#1.Dar llave
execute as @r[gamemode= survival,limit=1] run give @s diamond_sword{display:{Name:"{\"text\": \"Llave de Eski\", \"color\":\"gray\", \"bold\": true,\"italic\": true }"},HideFlags:1b,RepairCost:100,Damage:0,Enchantments:[{id:silk_touch,lvl:1s}]} 1 
