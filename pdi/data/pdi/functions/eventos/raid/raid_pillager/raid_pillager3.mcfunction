#0.Raid Pillager 1 "Grande"

#1.Inicio
title @a times 20 60 20
title @a title {"text": "PREPARATE PARA LA GUERRA","color": "dark_gray","bold": true}
...
summon vindicator ~32 ~ ~30 {Tags:[vindicador1],Patrolling:1b,PatrolLeader:0b,HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}},{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}}]}
summon vindicator ~-32 ~ ~30 {Tags:[vindicador1],Patrolling:1b,PatrolLeader:0b,HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}},{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}}]}
summon ravager ~36 ~ ~30 {Passengers:[{id:pillager,Tags:[pillager1],Patrolling:1b,PatrolLeader:0b,HandItems:[{id:"minecraft:crossbow",Count:1b},{}],ArmorItems:[{},{},{id:"iron_chestplate",Count:1b},{}]}]}
...
#00.Debug
execute if score #game comprobador matches 1 run tellraw @a[gamemode= creative] ["Se activo la raid 3"]