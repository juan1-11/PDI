...
summon vindicator ~30 ~ ~32 {Tags:[vindicador1],Patrolling:1b,PatrolLeader:0b,HandItems:[{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}},{id:"minecraft:iron_axe",Count:1b,tag:{Enchantments:[{id:"sharpness",lvl:2s}]}}]}
...
#00.Debug
execute if score #game comprobador matches 1 run tellraw @a[gamemode= creative] ["Se activo la raid 2"]