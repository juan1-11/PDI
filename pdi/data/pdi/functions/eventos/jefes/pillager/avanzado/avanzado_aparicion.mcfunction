...
#1.Introduccion
scoreboard players set #avanzado comprobador 0
scoreboard players set #avanzado_on comprobador 1
...
#1.Creacion del jefe
summon vindicator ~ ~ ~ {Tags:["avanzado", "init"],CustomName:'{"text":"AVANZADO","color":"dark_red","bold":true}',CustomNameVisible:1b,Attributes:[{Name:"generic.max_health",Base:220.0},{Name:"generic.movement_speed",Base:0.3},{Name:"generic.follow_range",Base:40},{Name:generic.attack_damage,Base:12},{Name:generic.armor,Base:10}],Health:220.0,PersistenceRequired:1b}
