...
execute if score #game random matches 50..80 if score #game dificultad matches 1.. if score #mce1 mob_timer matches ..0 run function pdi:mob/cegadores/cegador_init1
execute if score #game random matches 120..150 if score #game dificultad matches 1.. if score #mce2 mob_timer matches ..0 run function pdi:mob/cegadores/cegador_init2
execute if score #game random matches 10..40 if score #game dificultad matches 1.. if score #mce2 mob_timer matches ..0 run function pdi:mob/cegadores/cegador_init3
