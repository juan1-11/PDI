...
scoreboard players remove #mzo4 mob_timer 1
scoreboard players remove #mzo5 mob_timer 1
scoreboard players remove #mzo6 mob_timer 1
scoreboard players remove #mzo7 mob_timer 1
